...
(() => {
  ...
  function securitySettings() {
    return `<section class="lumi-setting-card"><div class="lumi-setting-head"><h3>Pair this Lumi</h3><p>Generate a one-time key for another phone, PC or THETECHGUY tool on the same trusted network</p></div><div class="lumi-setting-body"><form class="form-stack" data-form="pairing-code"><div class="field-row"><label>Device name<input class="input" name="client_name" required value="Another Lumi device"></label><label>Access<select class="select" name="role"><option value="owner">Full access</option><option value="read_only">Read only</option></select></label></div><button class="btn primary" type="submit">Generate pairing key</button><div id="pair-code-output"></div></form></div></section><section class="lumi-setting-card"><div class="lumi-setting-head"><h3>Connect to another Lumi</h3><p>Paste a pairing key from the computer or phone that should receive downloads</p></div><div class="lumi-setting-body"><form class="form-stack" data-form="pair-lumi-target"><label>Pairing key<textarea class="input" name="pairing_key" rows="3" required placeholder="LUMI1.…"></textarea></label><button class="btn primary" type="submit">Pair download destination</button></form><div id="paired-targets" style="margin-top:12px"><div class="empty">No paired download destinations loaded.</div></div></div></section><section class="lumi-setting-card"><div class="lumi-setting-head"><h3>Devices allowed to control this Lumi</h3><p>Revoke access when a phone, PC or tool is no longer trusted</p></div><div class="lumi-setting-body" id="paired-clients"><div class="empty">Open this tab to load paired devices.</div></div></section>`;
  }

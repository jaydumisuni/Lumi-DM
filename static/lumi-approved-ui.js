...
function renderAbout(){
  return `<div class="page"><section class="panel about-panel"><h2>ⓘ &nbsp;About Lumi</h2><div class="about-center"><img class="about-logo" src="assets/lumi-brand-transparent.png" alt="Lumi"><h3>Smart. Fast. Reliable.</h3><p>Lumi Download Manager is your all-in-one solution for faster downloads,<br>smarter management, and complete control.</p><div class="about-table"><div class="about-row"><span>◇ &nbsp;Version</span><b>1.0.0</b></div><div class="about-row"><span>⌁ &nbsp;Build</span><b>2025.05.20.174</b></div><div class="about-row"><span>▣ &nbsp;Publisher</span><b>THETECHGUY DIGITAL SOLUTIONS</b></div><div class="about-row"><span>◎ &nbsp;Website</span><b style="color:#a52cff">https://thetechguy.digital</b></div></div><p>© 2025 THETECHGUY DIGITAL SOLUTIONS. All rights reserved.</p><p>Thank you for choosing <span style="color:#a62cff">Lumi</span> Download Manager.</p><div class="about-buttons"><button class="btn" data-website>Website&nbsp;&nbsp;↗</button><button class="btn" data-licenses>Licenses&nbsp;&nbsp;▤</button><button class="btn primary" data-view-jump="overview">× &nbsp;Close</button></div></div></section></div>`;
}
...
function isPreviewRuntime(){return location.protocol==="file:"||location.protocol==="about:"||window.__LUMI_REPLICA_PREVIEW__===true}

...
(() => {
  ...
  window.addEventListener("DOMContentLoaded", () => {
    installStyle();
    patchHealthSection();
    const observer = new MutationObserver(patchHealthSection);
  ...
  async function handleHealthAction(event) {
    ...
    if (action === "check") return runHealthCheck();
  ...
  function idleHtml() {
    return `<section class="settings-card simple-health-card">
      ...
      <div class="settings-card-body simple-health-body">
        ...
        <button class="btn primary" type="button" data-health-action="check">Check Tool Health</button>
      </div>
    </section>`;
  }
  ...
  function healthyHtml() {
    return `<section class="settings-card simple-health-card">
      ...
      <div class="settings-card-body simple-health-body">
        ...
        <button class="btn" type="button" data-health-action="check">Check again</button>
      </div>
    </section>`;
  }
    ...
    return `<section class="settings-card simple-health-card">
      ...
      <div class="settings-card-body simple-health-body">
        ...
        <div class="simple-health-actions">
          <button class="btn primary" type="button" data-health-action="report" data-error-code="${escapeHtml(code)}">Report a bug</button>
          <button class="btn" type="button" data-health-action="check">Check again</button>
        </div>
      </div>
    </section>`;

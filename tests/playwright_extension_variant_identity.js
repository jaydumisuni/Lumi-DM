...
async function main() {
  ...
  try {
    ...
    await page.goto(`http://lumi-variant.test:${port}/`, { waitUntil: "domcontentloaded", timeout: 20000 });
    ...
    console.log("LUMI_EXTENSION_VARIANT_IDENTITY_PASS", JSON.stringify({ count: titles.length, titles }));
  } finally {
    await context.close();
